...
//@Service
public class ChampionInfoServiceImpl_backup implements ChampionInfoService{
...
//챰피언 최종 아이템 리스트
	...
	public Map<Integer, Integer> championItem(int championId){
		...
		logger.info("itemMap:" + sortedMap);
		
		
		logger.info("championItem0List : " + championItem0List.get(0).getItem0());
